...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`first_meal`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`supplements`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`first_meal_supl`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`second_meal`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`second_meal_supl`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`third_meal`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`third_meal_supl`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`diet`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`nutritionist`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`sportsman`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`history_of_competitions`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`scheduled_competitions`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `khomyn_db`.`coach`;
...
insert into khomyn_db.nutritionist (full_name, reviews, diet_id) value("Dwight Monahan", 10, 1);
insert into khomyn_db.nutritionist (full_name, reviews, diet_id) value("Dr. Ramiro Hartmann", 9,3);
insert into khomyn_db.nutritionist (full_name, reviews, diet_id) value("Kali Labadie", 9.5,5);
insert into khomyn_db.nutritionist (full_name, reviews, diet_id) value("Bryon Jenkins", 7,4);
insert into khomyn_db.nutritionist (full_name, reviews,  diet_id) value("Russell Koch",8.8,2);
...
insert into khomyn_db.coach (sportsman_id,full_name,reviews ) value (1, "Trent Wiegand",7);
insert into khomyn_db.coach (sportsman_id,full_name,reviews ) value (2,"Kacey Schoen",10);
insert into khomyn_db.coach (sportsman_id,full_name,reviews ) value (3, "Kolby Brakus",8.8);
insert into khomyn_db.coach (sportsman_id,full_name,reviews ) value (4, "Llewellyn Borer",8);
insert into khomyn_db.coach (sportsman_id,full_name,reviews ) value (5,"Wallace Schumm",5.5);
